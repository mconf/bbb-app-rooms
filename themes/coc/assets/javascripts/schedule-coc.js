$(document).on('turbolinks:load', function(){
  var external = window.location.href.includes('/external')
  var wait = window.location.href.includes('/wait')
  if(window.location.href.includes('/scheduled_meetings') && !external && !wait){
