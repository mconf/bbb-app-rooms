    ...
    scope Mconf::Env.fetch('RELATIVE_URL_ROOT', '') do
      scope 'rooms' do
        ...
        scope ':id/recording/:record_id' do
          ...
          get '/eduplay', to: 'rooms#eduplay', as: 'eduplay'
          post '/eduplay', to: 'rooms#eduplay_auth'
          post '/eduplay_upload', to: 'rooms#eduplay_upload'
      ...
      resources :rooms, only: :show do
        ...
        resources :scheduled_meetings, only: [:new, :create, :edit, :update, :destroy] do
          ...
          resources :meetings, as: :internal, only: [] do
            ...
            get :ai_naming_suggestion_status, to: 'meetings#ai_naming_suggestion_status'
